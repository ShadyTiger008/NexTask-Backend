  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Edit3 className='w-4 h-4 cursor-pointer text-emerald-500 hover:text-emerald-700'/>
      </DialogTrigger>
      <DialogContent className="">
        ...
        <div className="flex flex-col gap-2">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-3'>
            ...
            className='w-full h-8 bg-black text-white hover:bg-black/70'>Submit</Button>  
          </form>
        </div>
      </DialogContent>
    </Dialog>

...
const CompletedTaskPage = (props: Props) => {
  ...
  const getTodoList = async () => {
    try {
      const response = await axios.get(`http://localhost:3001/todo/completedTodList/${user._id}`);
    ...
    <main className='flex flex-col gap-5 px-5'>
      <div className='flex flex-row justify-between'>
        <Heading
          ...
          description="Check your completed tasks and delete"
          icon={ListChecks}
